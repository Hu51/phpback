    ...
    <div class="col-md-10 col-md-offset-1 dashboard-center">
        <nav class="navbar navbar-inverse" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-01">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?= base_url() . 'admin/users'; ?>">Users Management</a></li>
                    <li class="active"><a href="<?= base_url() . 'admin/system'; ?>">System Settings</a></li>
                </ul>
                <p class="navbar-text navbar-right">Signed in as <span style="color:#27AE60"><?= $_SESSION['phpback_username']; ?></span><a href="<?= base_url() . 'action/logout'; ?>">
        ...
        <div>
                ...
                <form role="form" method="post" action="<?= base_url() . 'adminaction/editsettings' ?>">
                    <?php foreach ($settings as $setting): ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="setting-<?= $setting->id; ?>" value="<?= $setting->value; ?>" style="width:300px">
                        </div>
                    <?php endforeach; ?>
                    <div class="form-group">
            ...
            <div id="upgradetable" style="display:none">
                <div class="alert alert-<?= ($isLastVersion) ? 'success' : 'warning'; ?>" role="alert">You are running PHPBack v<?= $version; ?><br/>
                    <?php if ($isLastVersion): ?>
                        You're running the latest version of PHPBack.
                    <?php else: ?>
                        Please, upgrade to PHPBack v<?= $lastVersion; ?><br/><br/>
                        <a href="<?= base_url(); ?>adminaction/upgrade" class="btn btn-primary">Upgrade</a><br/>
            ...
            <div id="categorytable" style="display:none">
                ...
                <form role="form" name="update-form" method="post" action="<?= base_url() . 'adminaction/updatecategories' ?>">
                    <?php foreach ($categories as $cat): ?>
                        <div class="form-group">
                            <input type="text" class="form-control" name="category-<?= $cat->id; ?>" style="width:300px" value="<?= $cat->name; ?>">
                        </div>
                    <?php endforeach; ?>
                    <div class="form-group">
